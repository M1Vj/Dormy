...
import { getAdminOverviewInsights, getAiWorkspaceData } from "@/app/actions/ai";
...
export default async function AiPage() {
  ...
  const insightsResult = await getAdminOverviewInsights();
  const initialInsights =
    "error" in insightsResult ? null : { kind: "admin_overview" as const, data: insightsResult };
