...
import { getAiWorkspaceData, getMaintenanceInsights } from "@/app/actions/ai";
...
export default async function AiPage() {
  ...
  const insightsResult = await getMaintenanceInsights();
  const initialInsights =
    "error" in insightsResult ? null : { kind: "maintenance" as const, data: insightsResult };
