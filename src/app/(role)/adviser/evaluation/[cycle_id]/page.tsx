...
export default async function AdviserCycleDetailsPage({ params }: Props) {
      ...
      <Tabs defaultValue="templates" className="space-y-4">
        ...
        <TabsContent value="templates" className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <CreateTemplateDialog dormId={dormId} cycleId={cycle_id} rolePath="adviser" />
          </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <Button variant="outline" className="w-full" asChild>
                      <Link href={`/adviser/evaluation/${cycle_id}/templates/${template.id}`}>Edit Metrics & Weights</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
