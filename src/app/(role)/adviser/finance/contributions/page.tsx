...
export default async function AdviserContributionFinancePage() {
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Treasurer workflows for per-event charging and collection remain in treasurer routes. This page is a role-safe summary view.
          </CardDescription>
        </CardHeader>
      </Card>
    </div>
