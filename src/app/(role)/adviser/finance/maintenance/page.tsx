...
export default async function MaintenancePage({
  ...
  const hasAccess = roles.some((role) =>
    new Set(["adviser", "assistant_adviser", "student_assistant", "admin"]).has(role)
  );
  if (!hasAccess) {
    return (
      <div className="p-6 text-sm text-muted-foreground">
      ...
      <Tabs defaultValue="balances" className="space-y-6">
        ...
        <TabsContent value="balances" className="space-y-6">
          <CollectionFilters
            ...
            basePath="/adviser/finance/maintenance"
            search={search}
            status={statusFilter}
        ...
        <TabsContent value="expenses" className="space-y-6">
          <MaintenanceExpensesWorkspace
            ...
            canSubmit={roles.some(r => new Set(["admin", "adviser", "assistant_adviser", "student_assistant"]).has(r))}
            canReview={roles.some(r => new Set(["admin", "adviser", "assistant_adviser", "student_assistant"]).has(r))}
