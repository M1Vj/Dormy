      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Outstanding collectibles</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Gadgets</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">₱{balance.gadgets.toFixed(2)}</div>
          </CardContent>
        </Card>
      </div>
