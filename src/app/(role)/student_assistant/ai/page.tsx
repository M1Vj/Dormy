...
import { getAiWorkspaceData, getCleaningFinesInsights } from "@/app/actions/ai";
...
export default async function AiPage() {
  ...
  const insightsResult = await getCleaningFinesInsights();
  const initialInsights =
    "error" in insightsResult ? null : { kind: "cleaning_fines" as const, data: insightsResult };
